...
public class Electriciansolutions extends AppCompatActivity {
    String rollno;
    String comment;
    String category;
    String place;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new ArrayAdapter<String>(Electriciansolutions.this,android.R.layout.simple_list_item_1,arrayList);
