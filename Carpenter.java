        ...
        mdatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot data : dataSnapshot.getChildren()) {
                    ...
                    if (data.child("Status:").getValue(String.class).equals("0") && (data.child("Problem").getValue(String.class).equals("Carpenter"))) {
                        Intent i = new Intent(Carpenter.this, Carpentersolutions.class);
